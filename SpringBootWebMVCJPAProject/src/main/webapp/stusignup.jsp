...
<head>
    ...
    <link rel="icon" href="static/website_icons/student.svg" type="image/svg+xml">
    <link rel="stylesheet" href="style/stusignup.css"/>
...
<body>
    ...
    <div class="signup-container">
        <form class="signup-form" method="post" action="stureg">
